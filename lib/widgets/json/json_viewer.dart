...
class _JsonViewerState extends State<JsonViewer> {
  ...
  final _SizeUpdateController _sizeUpdateController = _SizeUpdateController(0);
  ...
  void didUpdateWidget(covariant JsonViewer oldWidget) {
    ...
    if (controller != null && !identical(controller, oldWidget.controller)) {
    ...
    return Scrollbar(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          var width = computeWidth(treeNode, widget.theme);
          _sizeUpdateController.width = math.max(constraints.maxWidth, width);
          return Scrollbar(
            thumbVisibility: true,
            ...
            child: SingleChildScrollView(
              ...
              child: _SizeUpdateContainer(
                controller: _sizeUpdateController,
                      ...
                      slivers: [
                        TreeSliver(
                          ...
                          treeRowExtentBuilder:
                              (node, dimensions) => _rowHeight,
                          toggleAnimationStyle: AnimationStyle.noAnimation,
                          indentation: TreeSliverIndentationType.none,
                          onNodeToggle: (node) {
                            _sizeUpdateController.width = math.max(
                              constraints.maxWidth,
                              computeWidth(treeNode, widget.theme),
                            );
                          },
                        ),
                      ],
  ...
  double computeWidth(
    ...
    var textSpan = t.content.computeTextSpan(
      expanded: t.expanded,
      hasChild: t.hasChild,
      indentDepth: t.depth,
      theme: theme,
...
class _SizeUpdateController extends ChangeNotifier {
  double _width;
  ...
  _SizeUpdateController(this._width);
}
...
class _SizeUpdateContainer extends StatefulWidget {
  ...
  final _SizeUpdateController controller;
...
class _JsonViewerRowItem extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    var content = node.content! as TreeNodeData;
    ...
    var textSpan = content.computeTextSpan(
